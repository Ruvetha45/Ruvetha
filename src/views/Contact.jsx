    ...
    <div
      ...
      className={
        darkMode
          ...
          : "pt-24 text-white md:h-screen"
      }
    >
      <div className="max-w-7xl mx-auto x-4 sm:px-6 lg:px-8 px-4 text-black">
        <h2 className="text-5xl font-bold px-4 md:px-0 text-center z-0 text-black">
          Contact
        </h2>
        <div>
